...
Disulphide bridges can be specified using -ss. This option can be
...
cut-off distance, by giving the keyword 'auto' as argument to -ss.
...
class martini22p:
    def __init__(self):
        ...
        self.sidechains = {
          ...
          "PHE": [spl("SC5 SC5 SC5"),    [(0.310,7500), (0.270,None), (0.270,None),(0.270,None)],[(150,50),(150,50)],        [(0,50)]],
          "HIS": [spl("SC4 SP1 SP1"),    [(0.320,7500), (0.270,None), (0.270,None),(0.270,None)],[(150,50),(150,50)],        [(0,50)]],
          "GLN": [spl("Nda D D"),        [(0.400,5000), (0.220,None)],                           [],                         [],              [(0.5,)]],
          "ASN": [spl("Nda D D"),        [(0.320,5000), (0.220,None)],                           [],                         [],              [(0.5,)]],
          "SER": [spl("N0 D D"),         [(0.250,7500), (0.220,None)],                           [],                         [],              [(0.5,)]],
          "THR": [spl("N0 D D"),         [(0.260,9000), (0.220,None)],                           [],                         [],              [(0.5,)]],
...
class elnedyn:
    def __init__(self):
        ...
        self.connectivity = {
        #RES       BONDS                                     ANGLES                            DIHEDRALS       V-SITE
        "TRP":     [[(0, 1), (1, 2), (2, 4), (4, 3), (3, 1)],[(0, 1, 2), (0, 1, 4), (0, 1, 3)],[(1, 2, 3, 4)]],
...
class elnedyn22p:
    def __init__(self):
        ...
        'PHE': [spl("SC5 SC5 SC5"),     [(0.340, 7500), (0.340,7500), (0.240,None), (0.240,None), (0.240,None)],                 [(70,100), (125,100)]],
        'HIS': [spl("SC4 SP1 SP1"),     [(0.195, None), (0.340,   0), (0.193,None), (0.295,None), (0.216,None)],                 [(135,100),(115, 50)]],
        'GLN': [spl("Nda D D"),         [(0.300, 2400), (0.220,None)],                                                           [],                             [],         [(0.5,)]],
        'ASN': [spl("Nda D D"),         [(0.250,61000), (0.220,None)],                                                           [],                             [],         [(0.5,)]],
        'SER': [spl("N0 D D"),          [(0.195,94000), (0.220,None)],                                                           [],                             [],         [(0.5,)]],
        'THR': [spl("N0 D D"),          [(0.195,94000), (0.220,None)],                                                           [],                             [],         [(0.5,)]],
        'ARG': [spl("N0 Qd D"),         [(0.250,12500), (0.350,6200), (0.110,None)],                                             [(150,15)]],
        'LYS': [spl("C3 Qd D"),         [(0.250,12500), (0.300,9700), (0.110,None)],                                             [(150,20)]],
        'ASP': [spl("Qa D"),            [(0.255,65000), (0.110,None)]],
...
def add_dummy(beads,dist=0.11,n=2):
    # Generate a random vector to add to the bead position
    ...
    # m sets the direction of the added vector
    m = 1
    for j in range(n):
        newbead = (beads[-1][0],tuple([i+(m*j) for i,j in zip(beads[-1][1],vn)]), beads[-1][2])
    ...
    def cg(self,force=False):
        ...
        for residue,rss in zip(self.residues,self.sstypes):
            ...
            if not residue[0][1] in CoarseGrained.mapping.keys():
                print CoarseGrained.mapping.keys()
