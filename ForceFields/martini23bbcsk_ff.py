...
# New martini 2.3 parameters.
# Changed: 
#   Backbone beads to S-type (except for Ala and charged termini)
#   Neutral sidechains beads of Ser, Cys and Lys to S-type

class martini23bbcsk:
    ff = True
    def __init__(self):
        import SS,FUNC,IO 

        # parameters are defined here for the following (protein) forcefields:
        self.name = 'martini23bbcsk'
        ...
        self.sidechains = {
            ...
            "LYS": [FUNC.spl("SC3 Qd"),         [(0.330,5000), (0.280,5000)],                           [(180,25)]],
            "CYS": [FUNC.spl("SC5"),            [(0.310,7500)]],
