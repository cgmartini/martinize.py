...
# New martini 2.3p parameters.
# Changed: 
#   BB beads to S-type (except Ala and charged termini)
#   Cys and neutral Lys SC-bead to S-type (Ser SC-beads not, for they bear dummy charges)

class martini23pbbcsk:
    ff = True
    def __init__(self):
        import SS,FUNC,IO 

        # parameters are defined here for the following (protein) forcefields:
        self.name = 'martini23pbbcsk'
        ...
        self.sidechains = {
          ...
          "LYS": [FUNC.spl("SC3 Qd D"),       [(0.330,5000), (0.280,5000), (0.110,None)],                         [(180,25)]],
    ...
    def messages(self):
        ...
        logging.warning('This is an experimental force field.')
