...
class elnedyn23_BB_CSK:
    ...
    - The Serine and cysteine sidechain bead and non-charged Lysine sidechain beads are turned to S-beads.
    '''
    ff = True
    def __init__(self):
        import SS,FUNC,IO 
        ...
        'LYS': [FUNC.spl("SC3 Qd"),          [(0.250,12500), (0.300,9700)],                                           [(150,20)]],
        'CYS': [FUNC.spl("SC5"),             [(0.240, None)]],
    ...
    def messages(self):
        ...
        logging.warning('This is an experimental forcefield, where BB and first SC-beads of Cysteine, Serine and Lysine are turned to S-beads.'
        pass
