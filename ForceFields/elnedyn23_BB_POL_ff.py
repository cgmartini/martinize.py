...
class elnedyn23_BB_POL:
    ...
    - All BB beads are turned to S-beads (except Ala and charged termini).
    - All polar sidechain beads (Gln, Asn, Thr,Cys) are turned to S-beads.
        (Neutral forms of the charged residues should also be turned to S, but martinize does not handle these.)
    '''
    ff = True
    def __init__(self):
        import SS,FUNC,IO 
        ...
        self.bbdef    =     FUNC.spl("SN0  SNda   SN0   SNd   SNa  SNda  SNda   SP5   SP5")  # Default beads   #@#
        self.bbtyp    = {                                                                    #                 #@#
                     "ALA": FUNC.spl(" C5    N0    C5    N0    N0    N0    N0    P4    P4"), # ALA specific    #@#
                     "PRO": FUNC.spl("SC5   SN0   SC5   SN0   SNa   SN0   SN0   SP4   SP4"), # PRO specific    #@#
                     "HYP": FUNC.spl("SC5   SN0   SC5   SN0   SN0   SN0   SN0   SP4   SP4")  # HYP specific    #@#
        }                                                                                    #                 #@#
        ## BONDS ##                                                                          #                 
        ...
        'ASN': [FUNC.spl("SP5"),             [(0.250, None)]],
        'PRO': [FUNC.spl("C3"),              [(0.190, None)]],
        'GLN': [FUNC.spl("SP4"),             [(0.300, 2400)]],
        'SER': [FUNC.spl("SP1"),             [(0.195, None)]],
        'THR': [FUNC.spl("SP1"),             [(0.195, None)]],
    ...
    def messages(self):
        ...
        logging.warning('This is an experimental forcefield, where BB and polar SC beads are changed to S-beads.')
        pass
